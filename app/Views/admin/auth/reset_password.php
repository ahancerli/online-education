                    ...
                    <div class="kt-login__container">
                        <div class="kt-login__body">
                            <div class="kt-login__logo">
                                <a href="#">
                                    <img src="<?= base_url('assets/admin') ?>/media/company-logos/logo-2.png">
                                </a>
                            </div>
                            <div class="kt-login__signin">
                                <div class="kt-login__head">
                                    <h3 class="kt-login__title">Şifrenizi Sıfırlayın</h3>
                                </div>
                                <div class="kt-login__form">
                                    <?= view('Myth\Auth\Views\_message_block') ?>

                                    <form action="<?= route_to('admin-reset-password') ?>" method="post">
                                        <?= csrf_field() ?>
                                        <input type="hidden" name="token" value="<?= $token ?>">
                                        <input type="hidden" name="email" value="<?= $email ?>">
                                        <div class="form-group">
                                            <input class="form-control" type="password" placeholder="Yeni Şifreniz" name="password" required>
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control form-control-last" type="password" placeholder="Yeni Şifrenizi Tekrarlayın" name="pass_confirm" required>
                                        </div>
                                        <div class="kt-login__actions">
                                            <button type="submit" class="btn btn-brand btn-pill btn-elevate">Şifreyi Sıfırla</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
