...
class AuthController extends Controller
{
    ...
    public function login()
    {
        ...
        if ($this->auth->check()) {
            $redirectURL = session('redirect_url') ?? '/admin';
        ...
        return view('admin/auth/login', ['config' => $this->config]);
    }
    ...
    public function forgotPassword()
    {
        if ($this->config->activeResetter === false) {
            return redirect()->route('admin_login')->with('error', lang('Auth.forgotDisabled'));
        }
    ...
    public function resetPassword()
    {
        ...
        if (!$token = $this->request->getGet('token'))
            return redirect()->to('/');
    ...
    public function attemptReset()
    {
        ...
        return redirect()->route('admin_login')->with('message', lang('Auth.resetSuccess'));
    }
    ...
    public function activateAccount()
    {
        ...
        if (is_null($user)) {
            return redirect()->route('admin_login')->with('error', lang('Auth.activationNoUser'));
        }
        ...
        return redirect()->route('admin_login')->with('message', lang('Auth.registerSuccess'));
    }
    ...
    public function resendActivateAccount()
    {
        ...
        // Success!
        return redirect()->route('admin_login')->with('message', lang('Auth.activationSuccess'));
